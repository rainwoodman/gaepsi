/* Generated by Cython 0.16 on Sat Jun 30 23:43:56 2012 */
...
struct __pyx_vtabstruct_6gaepsi_6cython_6zorder_Zorder {
  ...
  void (*decode_float)(struct __pyx_obj_6gaepsi_6cython_6zorder_Zorder *, int64_t, double *);
  int64_t (*encode_float)(struct __pyx_obj_6gaepsi_6cython_6zorder_Zorder *, double *);
  void (*float_to_int)(struct __pyx_obj_6gaepsi_6cython_6zorder_Zorder *, double *, int32_t *);
  void (*BBint)(struct __pyx_obj_6gaepsi_6cython_6zorder_Zorder *, double *, float, int32_t *, int32_t *, int32_t *);
};
...
static CYTHON_INLINE void __pyx_f_6gaepsi_6cython_6zorder_6Zorder_decode_float(struct __pyx_obj_6gaepsi_6cython_6zorder_Zorder *, int64_t, double *);
static CYTHON_INLINE int64_t __pyx_f_6gaepsi_6cython_6zorder_6Zorder_encode_float(struct __pyx_obj_6gaepsi_6cython_6zorder_Zorder *, double *);
static CYTHON_INLINE void __pyx_f_6gaepsi_6cython_6zorder_6Zorder_float_to_int(struct __pyx_obj_6gaepsi_6cython_6zorder_Zorder *, double *, int32_t *);
...
struct __pyx_vtabstruct_6gaepsi_6cython_5ztree_Tree {
  ...
  int32_t (*_estimate_radius)(struct __pyx_obj_6gaepsi_6cython_5ztree_Tree *, double *, int);
  ...
  void (*query_neighbours_one)(struct __pyx_obj_6gaepsi_6cython_5ztree_Tree *, struct __pyx_obj_6gaepsi_6cython_5ztree_Result *, double *);
};
...
static float __pyx_f_6gaepsi_6cython_6_field_solve_sml_one(float *, float *, int, float); /*proto*/
static struct __pyx_array_obj *__pyx_array_new(PyObject *, Py_ssize_t, char *, char *, char *); /*proto*/
 ...
 *             size = size - 1
 */
                (((float *)(__pyx_v_citer.data[4]))[0]) = __pyx_f_6gaepsi_6cython_6_field_solve_sml_one(__pyx_v_r_ptr, __pyx_v_w_ptr, __pyx_v_NGB, (__pyx_v_w0 / ((4.0 * 3.1416) / 3.0)));
                goto __pyx_L12;
              }
              __pyx_L12:;
...
static CYTHON_INLINE void __pyx_f_6gaepsi_6cython_6zorder_6Zorder_decode_float(struct __pyx_obj_6gaepsi_6cython_6zorder_Zorder *__pyx_v_self, int64_t __pyx_v_key, double *__pyx_v_pos) {
...
static CYTHON_INLINE int64_t __pyx_f_6gaepsi_6cython_6zorder_6Zorder_encode_float(struct __pyx_obj_6gaepsi_6cython_6zorder_Zorder *__pyx_v_self, double *__pyx_v_pos) {
  int32_t __pyx_v_point[3];
  int __pyx_v_d;
  int64_t __pyx_r;
  int __pyx_t_1;
...
static CYTHON_INLINE void __pyx_f_6gaepsi_6cython_6zorder_6Zorder_float_to_int(struct __pyx_obj_6gaepsi_6cython_6zorder_Zorder *__pyx_v_self, double *__pyx_v_pos, int32_t *__pyx_v_point) {
  int __pyx_v_d;
  int __pyx_t_1;
